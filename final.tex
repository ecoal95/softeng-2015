...
\newcommand{\subtitle}{\begin{center}\sffamily\bfseries\fontsize{20pt}{1em}\selectfont Ejemplo \vspace{40pt}\end{center}}
...
\newcommand{\version}{\begin{center}\sffamily\bfseries\itshape\fontsize{16pt}{1em}\selectfont Ejem. 1.0. \vspace{20pt}\end{center}}

% we don't use the latex date to put it before the authors
\date{}
\newcommand{\customdate}{\begin{center}\sffamily\bfseries\itshape\fontsize{16pt}{1em}\selectfont Fecha \vspace{90pt}\end{center}}
...
\begin{customtable}
    ...
    \textbf{Objetivos asociados} & \frassocobjs \\ \hline
    \textbf{Requisitos asociados} & \frassocreqs \\ \hline
...
\newkeycommand\nonfunctionalrequisite[id=x,version=1.0,importance=\high,urgency=\medium,state=\validated,stability=\high][6]{
\begin{customtable}
    \hline
    \textbf{IRQ-\commandkey{id}} & \textbf{#1} \\ \hline
    \textbf{Versión} & \commandkey{version} \\ \hline
