...
% name, authors, description, sources
\newcommand\high{Alta}
\newcommand\veryhigh{Muy Alta}
\newcommand\medium{Media}
\newcommand\vital{Vital}
\newcommand\verified{Verificado}
\newkeycommand\objective[id=x,version=1.0,importance=\high,urgency=\medium,state=\verified,stability=\high][4]{%
\begin{tabularx}{\textwidth}{|l|X|}
    \hline
    \textbf{OBJ-\commandkey{id}} & #1 \\ \hline
    \textbf{Version} & \commandkey{version} \\ \hline
    \textbf{Authors} & #2 \\ \hline
    \textbf{Descripción} & #3 \\ \hline
    \textbf{Fuentes} & #4 \\ \hline
