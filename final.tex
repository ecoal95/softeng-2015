...
\title{Ejemplo}
\author{Emilio Cobos, Celia Herrera, Víctor Barrueco}
...
\fancyhead{}
\fancyfoot{}
\fancyhead[LO]{\bfseries\fontsize{11pt}{2em}\selectfont{Ejemplo}}
\fancyhead[RO,LE]{\bfseries\fontsize{11pt}{2em}\selectfont{\thepage}}
\fancyhead[RE]{\bfseries\fontsize{11pt}{2em}\selectfont{E. Cobos, C. Herrera, V. Barrueco}}
...
\newcommand{\subtitle}{\begin{center}\vspace{12pt}\sffamily\bfseries\fontsize{20pt}{1em}\selectfont Ejemplo \vspace{40pt}\end{center}}
...
\newcommand{\version}{\begin{center}\vspace{20pt}\sffamily\bfseries\itshape\fontsize{16pt}{1em}\selectfont Ejem. 1.0. \vspace{20pt}\end{center}}

% we don't use the latex date to put it before the authors
\date{}
\newcommand{\customdate}{\begin{center}\vspace{20pt}\sffamily\bfseries\itshape\fontsize{16pt}{1em}\selectfont Fecha \vspace{90pt}\end{center}}
...
\newkeycommand\objective[id=x,version=1.0,importance=\high,urgency=\medium,state=\validated,stability=\high][5]{%
...
\newkeycommand\informationrequisite[id=x,version=1.0,importance=\high,urgency=\medium,state=\validated,stability=\high][8]{
\begin{tabularx}{\textwidth}{|l|X|}
    \hline
    ...
    \textbf{Objetivos asociados} & #4 \\ \hline
    \textbf{Requisitos asociados} & #5 \\ \hline
...
% Nombre, autores, fuentes, objetivos asociados, requisitos asociados, descripción, precondición(es), secuencia normal, excepciones
\newkeycommand\functionalrequisite[id=x,version=1.0,importance=\high,urgency=\medium,state=\validated,stability=\high][9]{
\begin{tabularx}{\textwidth}{|l|X|}
    \hline
    \textbf{FRQ-\commandkey{id}} & \textbf{#1} \\ \hline
    \textbf{Versión} & \commandkey{version} \\ \hline
    \textbf{Autores} & #2 \\ \hline
    \textbf{Fuentes} & #3 \\ \hline
    \textbf{Objetivos asociados} & #4 \\ \hline
...
\newkeycommand\actor[id=x,version=1.0][4]{
\begin{tabularx}{\textwidth}{|l|X|}
    \hline
